...
describe('JSON to expression', function() {
  ...
  it('test condition operand lessThan (false)', async () => {
    const condition = {
      "type": "condition",
      "operand1": "{{age}}",
      "operator": TiledeskExpressionV2.OPERATORS.lessThan.name,
      "operand2": {
        type: "const",
        value: "10"
      }
    ...
    const expression = TiledeskExpressionV2.JSONConditionToExpression(condition, vars);
    console.log("expression:", expression);
    assert(expression === 'Number("12") < Number("10")');
    const result = new TiledeskExpressionV2().evaluateStaticExpression(expression);
    assert(result === false);
  });
  ...
  it('test condition operand lessThan (false)', async () => {
    const condition = {
      "type": "condition",
      "operand1": "{{name}}",
      "operator": TiledeskExpressionV2.OPERATORS.equalAsStrings.name,
      "operand2": {
        type: "const",
        value: "Andrea"
      }
    ...
    const expression = TiledeskExpressionV2.JSONConditionToExpression(condition, vars);
    console.log("expression:", expression);
    assert(expression === 'String("Andrea") === String("Andrea")');
    const result = new TiledeskExpressionV2().evaluateStaticExpression(expression);
    assert(result === true);
  });

  it('test condition operand === comparing 2 string constants (true)', async () => {
    const condition = {
      "type": "condition",
      "operand1": "Andrea",
      "operator": TiledeskExpressionV2.OPERATORS.equalAsStrings.name,
  ...
  it('test condition operand === comparing 2 string constants (false)', async () => {
    const condition = {
      "type": "condition",
      "operand1": "Marco",
      "operator": TiledeskExpressionV2.OPERATORS.equalAsStrings.name,
    ...
    const expression = TiledeskExpressionV2.JSONConditionToExpression(condition, vars);
    console.log("expression:", expression);
    assert(expression === 'String("Marco") === String("Andrea")');
    const result = new TiledeskExpressionV2().evaluateStaticExpression(expression);
    assert(result === false);
  });

  it('test condition operand lessThan comparing 2 const values (false)', async () => {
    const condition = {
      "type": "condition",
      "operand1": "12",
      "operator": TiledeskExpressionV2.OPERATORS.lessThan.name,
  ...
  it('test condition operand lessThan comparing 2 const values (true)', async () => {
    const condition = {
      "type": "condition",
      "operand1": "12",
      "operator": TiledeskExpressionV2.OPERATORS.lessThan.name,
    ...
    const expression = TiledeskExpressionV2.JSONConditionToExpression(condition);
    console.log("expression:", expression);
    assert(expression === 'Number("12") < Number("14")');
    const result = new TiledeskExpressionV2().evaluateStaticExpression(expression);
    assert(result === true);
  });
  ...
  it('test condition operand greaterThan (true)', async () => {
    const condition = {
      "type": "condition",
      "operand1": "{{age}}",
      "operator": TiledeskExpressionV2.OPERATORS.greaterThan.name,
      "operand2": {
        type: "const",
        value: "10"
      }
  ...
  it('test condition operand isEmpty (true)', async () => {
    const condition = {
      "type": "condition",
      "operand1": "{{name}}",
      "operator": TiledeskExpressionV2.OPERATORS.isEmpty.name,
      "operand2": {
        type: "const",
        value: null
      }
  ...
  it('test condition operand isNull (true)', async () => {
    const condition = {
      "type": "condition",
      "operand1": "{{name}}",
      "operator": TiledeskExpressionV2.OPERATORS.isNull.name,
      "operand2": {
        type: "const",
        value: null
      }
    ...
    const result = new TiledeskExpressionV2().evaluateStaticExpression(expression, vars);
    assert(result === true);
  });
