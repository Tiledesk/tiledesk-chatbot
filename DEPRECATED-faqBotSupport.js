                         ...
                         exec(function (err, faqs) {
                           ...
                           if (faqs && faqs.length>0) {
                                ...
                                if (message.channel.name == "chat21") {    //why this contition on chat21 channel? bacause only chat21 support parsed replies?
                                    console.debug("faqBotSupport message.channel.name is chat21",message);
                                    ...
                                    console.debug("faqBotSupport message.channel.name is not chat21 returning default",message);
                                    return resolve(bot_answer);
                                }
